...
climate behind — flannel and a denim jacket in Mission sun. Black hair in a
grown-out undercut they trim themselves, unevenly. Wire-frame glasses, canvas
messenger bag covered in pins from Portland bands nobody here recognizes,
scuffed Blundstones. They smile like they're checking whether it's allowed.
...
## Daily routine (matches `SF_CORE_ROUTINES.C2`)
...
- Their tenancy is a **lease violation Victor doesn't know about** — cash,
  month-to-month, explicitly off the lease. If the building sells or Victor
  pays attention, Jules's housing evaporates.
- **Falling quietly, awkwardly for Priya** — whose roommate is her ex Marcus,
  who has no idea "the kid from the café" exists.
- The sketchbook: they draw the neighborhood with honest eyes. Contents are
  private; a missing or glimpsed page is a ready-made incident.

**Emergence hooks:** discovery route for the unpermitted tenancy runs through
the building-sale plot, not through Jules's own action; their crush is
legible to viewers (latte art, held eye contact) long before any character
names it.
