#!/usr/bin/env python3
"""V8 canonical screenshots for sf-art-evolution. One browser session, four
fixed framings against willowbrook_natura.html?sf with pinned clear midday +
paused sim. Output: your_files/sf-art-evolution/v8-{A,B,C,D}.png"""
...
def main():
    with sync_playwright() as pw:
        ...
        pg.evaluate(PIN)
        pg.screenshot(path=OUT + 'v8-A.png')
        ...
        pg.evaluate(PIN + """;(() => {
          ...
          SF_CAM.yaw = Math.atan2(fy, fx); SF_CAM.pitch = 0.04; SF_CAM.h = 2.0;
        ...
        pg.wait_for_timeout(600)
        pg.evaluate(PIN)
        pg.screenshot(path=OUT + 'v8-B.png')
        ...
        pg.wait_for_timeout(600)
        pg.evaluate(PIN)
        pg.screenshot(path=OUT + 'v8-C.png')
        ...
        pg.wait_for_timeout(600)
        pg.evaluate(PIN)
        pg.screenshot(path=OUT + 'v8-D.png')
