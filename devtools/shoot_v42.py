#!/usr/bin/env python3
"""V42 canonical screenshots for sf-art-evolution. One browser session, four
fixed framings against willowbrook_natura.html?sf with pinned clear late-afternoon +
paused sim. Output: your_files/sf-art-evolution/v42-{A,B,C,D}.png"""
...
def main():
    with sync_playwright() as pw:
        ...
        pg.evaluate(PIN)
        pg.screenshot(path=OUT + 'v42-A.png')
        ...
        pg.wait_for_timeout(600)
        pg.evaluate(PIN)
        pg.screenshot(path=OUT + 'v42-B.png')
        ...
        pg.wait_for_timeout(600)
        pg.evaluate(PIN)
        pg.screenshot(path=OUT + 'v42-C.png')
        ...
        pg.wait_for_timeout(600)
        pg.evaluate(PIN)
        pg.screenshot(path=OUT + 'v42-D.png')
