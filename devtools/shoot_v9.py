...
paused sim. Output: your_files/sf-art-evolution/v9-{A,B,C,D}.png"""
...
def main():
    with sync_playwright() as pw:
        ...
        pg.evaluate(PIN)
        pg.screenshot(path=OUT + 'v9-A.png')
        ...
        pg.wait_for_timeout(600)
        pg.evaluate(PIN)
        pg.screenshot(path=OUT + 'v9-B.png')
        ...
        pg.wait_for_timeout(600)
        pg.evaluate(PIN)
        pg.screenshot(path=OUT + 'v9-C.png')
        ...
        pg.wait_for_timeout(600)
        pg.evaluate(PIN)
        pg.screenshot(path=OUT + 'v9-D.png')
