...
| Screenshots | ≥3, 16:9 | `press-kit/screenshots/v46-A..D.png` (4 ready, grounded-shadow build) |
...
Screenshots order on the page: v46-D (director view — the hook), v46-B
(street level), v46-C (Dolores Park), v16-int-cafe (interior vignette),
then v46-A and the v1 before/after pair lower down for dev-minded readers.
...
| itch.io | Screenshot set | 1440×900 | **Done** — `press-kit/screenshots/v46-A..D` |
...
`press-kit/captions.txt` as canonical): v46-D "director view" → "Aerial view
of the Mission block at golden hour — the spectator camera's home position.";
v46-B street level → "Street-level view: facades, parody storefront signage,
a resident mid-errand."; v46-C park → "Dolores Park edge — palms, lawn,
...
| Media | — | gallery: `keyart-16x9.png` + `v46-D/B/C` stills; video slot: `trailer/out/animatic-hero.mp4` until the real trailer exists |
