...
| Screenshots | ≥3, 16:9 | `press-kit/screenshots/v81-A..D.png` (4 ready, v81 coverage-grammar build) |
...
| itch.io | Screenshot set | 1440×900 | **Done** — `press-kit/screenshots/v81-A..D` |
...
`press-kit/captions.txt` as canonical): v81-D "director view" → "Director
...
height — REC cluster and DIRECTOR badge up top."; v81-B street level → "Street-level
close view of Jules on the sidewalk, Priya and Dani mid-block — dressed
storefronts, parked cars, leaves drifting, name tags overhead."; v81-C
...
edge, tennis courts on the south edge."; v81-A overhead → "The Mission block from
