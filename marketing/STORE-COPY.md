...
| Screenshots | ≥3, 16:9 | `press-kit/screenshots/v28-A..D.png` (4 ready, grounded-shadow build) |
...
Screenshots order on the page: v28-D (director view — the hook), v28-B
(street level), v28-C (Dolores Park), v16-int-cafe (interior vignette),
then v28-A and the v1 before/after pair lower down for dev-minded readers.
...
| itch.io | Screenshot set | 1440×900 | **Done** — `press-kit/screenshots/v28-A..D` |
...
`press-kit/captions.txt` as canonical): v28-D "director view" → "Aerial view
of the Mission block at golden hour — the spectator camera's home position.";
v28-B street level → "Street-level view: facades, parody storefront signage,
a resident mid-errand."; v28-C park → "Dolores Park edge — palms, lawn,
...
rebased on the v28 art build. **v33 changes:** copy re-synced to the world
