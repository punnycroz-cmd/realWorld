...
| Screenshots | ≥3, 16:9 | `press-kit/screenshots/v21-A..D.png` (4 ready, grounded-shadow build) |
...
Screenshots order on the page: v21-D (director view — the hook), v21-B
(street level), v21-C (Dolores Park), v16-int-cafe (interior vignette),
then v21-A and the v1 before/after pair lower down for dev-minded readers.
...
| itch.io | Screenshot set | 1440×900 | **Done** — `press-kit/screenshots/v21-A..D` |
...
screenshot ordering, gallery rebased on the v21 art build (grounded
