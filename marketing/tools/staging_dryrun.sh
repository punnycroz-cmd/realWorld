...
for p in index.html features.html how-it-works.html pricing.html faq.html press-kit.html 404.html; do
...
for p in index features how-it-works pricing faq press-kit; do
  h="$SITE/$p.html"
