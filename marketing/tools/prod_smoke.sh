...
# 1. Pages 200 + TTFB
echo "[1] pages"
for p in "" index.html features.html cast.html how-it-works.html demo.html archive.html community.html journal.html rules.html brand.html pricing.html faq.html press-kit.html; do
