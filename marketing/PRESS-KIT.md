...
**Version:** v167 · 2026-09-24 · **Status:** LOCAL DRAFT — pre-launch.
...
| Screenshots | **Available** — 4 current-build shots (v81 set, matching the site gallery) + 2 interior vignettes (v16) + 2 early-pass shots (v1) | `press-kit/screenshots/` (mirrors `site/shots/`) |
...
| What's new sheet | **Available** — build-highlights crib (v53→…→v76→v79→v80→v81) for "what changed" coverage | `press-kit/whats-new.md` |
| AI transparency | **Available** — disclosure one-pager: what's AI-driven, what isn't, control rules, storefront AI-disclosure fields | `press-kit/ai-transparency.md` |
