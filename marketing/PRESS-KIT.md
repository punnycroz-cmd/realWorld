...
**Version:** v92 · 2026-09-23 · **Status:** LOCAL DRAFT — pre-launch.
...
| Screenshots | **Available** — 4 curated-build shots (v55 set; site gallery tracks latest at v61) + 2 interior vignettes (v16) + 2 early-pass shots (v1) | `press-kit/screenshots/` (mirrors `site/shots/`) |
...
| What's new sheet | **Available** — build-highlights crib (v53→v54→v55) for "what changed" coverage | `press-kit/whats-new.md` |
