...
cp site/assets/badge-watched.svg site/assets/badge-watched-mono.svg \
   "$KIT/badges/"
cp site/shots/v53-A.png site/shots/v53-B.png site/shots/v53-C.png \
   site/shots/v53-D.png site/shots/v16-int-cafe.png site/shots/v16-int-flat.png \
   site/shots/v1-A.png site/shots/v1-B.png \
   site/shots/v53-A.webp site/shots/v53-B.webp site/shots/v53-C.webp \
   site/shots/v53-D.webp \
   "$KIT/screenshots/"
