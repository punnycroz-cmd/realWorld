...
(function () {
  ...
  if (!url) {
    var SHOTS = [
      ["shots/v46-A", "the block from overhead under the marine layer"],
      ["shots/v46-B", "street-level follow-cam inside the fog"],
      ["shots/v46-C", "Dolores Park under a drifting fog tongue"],
      ["shots/v46-D", "director mode — pastel rowhouses on the sloped block"]
    ];
