...
| 2 | 0:05–0:12 | S2 | Top-down dawn over the Mudhaus block (v30-A framing). Slow drift. Tiny pawns move on real streets. | **[T]** "A neighborhood in San Francisco." |
| 3 | 0:12–0:19 | S3 | Street-level follow behind a resident walking 24th St (v30-B framing). | **[T]** "Twenty-eight people live here." |
| 4 | 0:19–0:26 | S4 | Dolores Park overhead, palms and paths (v30-C). Pawns drift toward the grass. | **[T]** "They work. They fall in love. They keep secrets." |
| 5 | 0:26–0:33 | S5 | Director-mode low orbit over Victorian rooftops, water towers, laundry lines (v30-D). Long shadows. | **[T]** "None of them know you're watching." Music: first swell. |
...
|----|---------|----------|-----------------|
| S2 | Top-down, slow E→W drift over Mudhaus block | dawn, dry | matches `site/shots/v30-A.png` |
| S3 | Street-follow behind one walking pawn, 24th St | late afternoon, dry | matches `v30-B.png` |
| S4 | Top-down Dolores Park, palms + paths | late afternoon, dry | matches `v30-C.png` |
| S5 | Director-mode low orbit, rooftops/water towers | golden hour | matches `v30-D.png` |
...
trailer against the existing v30 stills with slow push-ins (Ken Burns) and
...
1. **The watcher:** v30-D director shot, darkened edges, small red "REC" dot,
...
`marketing/trailer/` (§11), stills in `site/shots/` (v30 series + v16
