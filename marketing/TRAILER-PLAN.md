...
| 2 | 0:05–0:12 | S2 | Top-down dawn over the Mudhaus block (v43-A framing). Slow drift. Tiny pawns move on real streets. | **[T]** "A neighborhood in San Francisco." |
| 3 | 0:12–0:19 | S3 | Street-level follow behind a resident walking 24th St (v43-B framing). | **[T]** "Twenty-eight people live here." |
| 4 | 0:19–0:26 | S4 | Dolores Park overhead, palms and paths (v43-C). Pawns drift toward the grass. | **[T]** "They work. They fall in love. They keep secrets." |
| 5 | 0:26–0:33 | S5 | Director-mode low orbit over Victorian rooftops, water towers, laundry lines (v43-D). Long shadows. | **[T]** "None of them know you're watching." Music: first swell. |
...
|----|---------|----------|-----------------|
| S2 | Top-down, slow E→W drift over Mudhaus block | dawn, dry | matches `site/shots/v43-A.png` |
| S3 | Street-follow behind one walking pawn, 24th St | late afternoon, dry | matches `v43-B.png` |
| S4 | Top-down Dolores Park, palms + paths | late afternoon, dry | matches `v43-C.png` |
| S5 | Director-mode low orbit, rooftops/water towers | golden hour | matches `v43-D.png` |
...
1. **The watcher** (`thumb-watcher.png`, style `rec`): v43-D director
...
2. **The handoff** (`thumb-handoff.png`, style `split`): v43-B street
   ...
   mechanic.
3. **The block at dusk** (`thumb-dusk.png`, style `wordmark`): v43-D
