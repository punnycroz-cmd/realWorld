...
|---|---|---|---|---|
| `/` (index.html) | Real World — A Living Neighborhood You Can Watch | truman show game, AI life sim | ✔ VideoGame | Hero `v36-D` preloaded (webp, fetchpriority=high); #wire feed-strip anchor — "the wire" copy is index-owned, demo.html owns "watch" queries |
...
one PNG fallback (v36-C, 1.9MB) is under the 2MB ceiling — accepted, it only
...
- Asset hooks that earn embeds: before/after v1→v36 gallery, the public request
...
1. `shots/v36-C.png` is 1.9MB and `v36-A.png` is 1.8MB (accepted — webp
