...
|---|---|---|---|---|
| `/` (index.html) | Real World — A Living Neighborhood You Can Watch | truman show game, AI life sim | ✔ VideoGame | Hero shot `v18-D` w/ fetchpriority=high |
...
one PNG fallback (v18-C, 2.1MB) exceeds 2MB — accepted, it only loads on
...
- Asset hooks that earn embeds: before/after v1→v18 gallery, the public request
