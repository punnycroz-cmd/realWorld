...
|---|---|---|---|---|
| `/` (index.html) | Real World — A Living Neighborhood You Can Watch | truman show game, AI life sim | ✔ VideoGame | Hero shot `v21-D` w/ fetchpriority=high |
...
one PNG fallback (v21-C, 2.1MB) exceeds 2MB — accepted, it only loads on
...
- Asset hooks that earn embeds: before/after v1→v21 gallery, the public request
