...
**Status: v19 — spec for post-launch clipping. LOCAL ONLY.** Nothing here
...
| `site/shots/` stills | Cards, end cards, thumbnails, fallback when feed is quiet | Ready (v19 captures) |
