...
## Published shots (`site/shots/`, development build v65 current; v61/v59/v55/v54/v53 kept for era posts)
...
| `v59-A`–`v59-D` | The wet-after-rain build — speckled damp pavement, ponding on flat roofs, stringcourses catching light at every floor line. Kept for era posts; v65 is the current build. |
...
| `v54-A`–`v54-D` | The facade-pass build — window boxes, AC sleeves, Juliet rails, house numbers, stoop pots on every frontage. Kept for era/before-after posts; v65 is the current build. |
