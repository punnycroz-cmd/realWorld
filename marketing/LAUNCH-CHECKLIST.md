...
(gallery at published v75), G9 (zip fresh), G18 (accuracy sweep clean); the
...
| G5 | Screenshot gallery refreshed with launch-build captures (current = **v75 dev build** — refreshed v151 — + v16 interior vignettes + v1 early-pass pair; gonogo.sh flags future deltas automatically) | mkt, needs art publish | `[x] REHEARSED` — swap procedure executed end-to-end 2026-09-23; repeat at launch if art publishes newer |
...
| 2026-09-24 | tools/gonogo.sh (v143, 18 gates) | 3/18 auto-green (G5 gallery v75, G9 zip fresh, G18 accuracy clean) — G5 flagged mid-version at v70<v71, cleared by the rebase above |
