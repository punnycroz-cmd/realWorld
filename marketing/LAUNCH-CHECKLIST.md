...
| G5 | Screenshot gallery refreshed with launch-build captures (current = **v47 dev build** — refreshed v77 — + v16 interior vignettes + v1 early-pass pair; gonogo.sh flags future deltas automatically) | mkt, needs art publish | `[x] REHEARSED` — swap procedure executed end-to-end 2026-09-23; repeat at launch if art publishes newer |
