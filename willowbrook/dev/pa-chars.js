...
const NV_CAST = [
  ...
  {id:'C1', tier:'core', skin:'#8a5a3b', skinD:'#6e452c', hair:'#1c1a18', hairD:'#0e0d0c',
   hairStyle:'afro', hat:'none', acc:'headphones', accCol:'#e8542f',
   shirt:'#0e7c7b', shirtD:'#0a5d5c', pants:'#2b2d42', pantsD:'#1f2130',
   boots:'#f4f1ea', bootsD:'#c9c4b8', outfit:'hoodie', prop:'phone'},
  {id:'C2', tier:'core', skin:'#c98a5e', skinD:'#a86a44', hair:'#3a2214', hairD:'#281709',
   hairStyle:'long', hat:'none', acc:'none',
   shirt:'#c33c54', shirtD:'#962a3e', pants:'#3b6ea5', pantsD:'#2c4f7d',
   boots:'#5a4028', bootsD:'#402c1c', outfit:'jacket', prop:'tote'},
  {id:'C3', tier:'core', skin:'#e8b88a', skinD:'#c69868', hair:'#9a9a98', hairD:'#76746f',
   hairStyle:'short', hat:'none', acc:'glasses', accCol:'#2b2b33',
   shirt:'#8a7a5c', shirtD:'#6b5e45', pants:'#4a4a52', pantsD:'#36363d',
   boots:'#4a3524', bootsD:'#33241a', outfit:'vest', prop:'coffee'},
  {id:'C4', tier:'core', skin:'#6e452c', skinD:'#54341f', hair:'#14100c', hairD:'#000000',
   hairStyle:'bun', hat:'none', acc:'none',
   shirt:'#e8b830', shirtD:'#bd9322', pants:'#5c3a52', pantsD:'#422a3c',
   boots:'#33241a', bootsD:'#241a10', outfit:'dress', prop:'coffee'},
  {id:'C5', tier:'core', skin:'#f0c49a', skinD:'#d6a06c', hair:'#7a4a24', hairD:'#5a3519',
   hairStyle:'short', hat:'beanie', hatCol:'#9a3a3a', acc:'beard',
   shirt:'#7a3040', shirtD:'#5c2330', pants:'#37474f', pantsD:'#263238',
   boots:'#4e3319', bootsD:'#38250f', outfit:'sweater', prop:'tote'},
  {id:'C6', tier:'core', skin:'#d6a878', skinD:'#b3855a', hair:'#2c2118', hairD:'#1c1410',
   hairStyle:'hijab', hat:'none', acc:'none', accCol:'#5a6e8c',
   shirt:'#5a6e8c', shirtD:'#44546c', pants:'#3c3a44', pantsD:'#2c2a32',
   boots:'#3a2a1a', bootsD:'#241a10', outfit:'dress', prop:'phone'},
  {id:'C7', tier:'core', skin:'#f5cfa0', skinD:'#dfa878', hair:'#e8c35a', hairD:'#c79a3f',
   hairStyle:'buzz', hat:'cap', hatCol:'#2f6b4f', acc:'none',
   shirt:'#e8e2d4', shirtD:'#bdb5a4', pants:'#c94f32', pantsD:'#a03a24',
   boots:'#f4f1ea', bootsD:'#c9c4b8', outfit:'tee', prop:'skate'},
  {id:'C8', tier:'core', skin:'#eab088', skinD:'#cf8f66', hair:'#b33ac9', hairD:'#84279a',
   hairStyle:'mohawk', hat:'none', acc:'none',
   shirt:'#23232a', shirtD:'#141418', pants:'#23232a', pantsD:'#141418',
   boots:'#14100c', bootsD:'#000000', outfit:'jacket', prop:'phone'},
